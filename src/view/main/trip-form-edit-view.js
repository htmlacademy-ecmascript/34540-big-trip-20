...
const createTripFormTypeGroupTemplate = (offers) => {
...
const createTripFormEditTemplate = (offers) => {
  const typeGroup = createTripFormTypeGroupTemplate(offers);
        ...
        <section class="event__section  event__section--offers">
         ...
         <section class="event__section  event__section--destination">
              ...
              <p class="event__destination-description">Chamonix-Mont-Blanc (usually shortened to Chamonix) is a resort
                  area near the junction of France, Switzerland and Italy. At the base of Mont Blanc, the highest summit
                  in the Alps, it's renowned for its skiing.</p>
         </section>
    </section>
  </form>`
  );
...
export default class TripFormEditView {
  ...
  getTemplate() {
    return createTripFormEditTemplate(this.offers);
  }
